...
import { APIPost, PostFlag, PostRating } from "../../models/api/responses/APIPost";
import { Blacklist } from "../../models/data/Blacklist";
import { Page, PageDefinition } from "../../models/data/Page";
import User from "../../models/data/User";
import { Post, PostData } from "../../models/post/Post";
import { PostActions } from "../../models/post/PostActions";
...
export class BetterSearch extends RE6Module {
    ...
    public constructor() {
        super([PageDefinition.posts.list, PageDefinition.favorites], true, true, [BlacklistEnhancer]);
    }
