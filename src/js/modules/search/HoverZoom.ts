...
export class HoverZoom extends RE6Module {
    ...
    public reloadEventListeners(): void {
        ...
        $("#page")
            .off("mouseenter.re621.zoom", "post, .thumbnail, div.post-thumbnail, sb-ctwrap subitem[data-id] img")
            .off("mouseleave.re621.zoom", "post, .thumbnail, div.post-thumbnail, sb-ctwrap subitem[data-id] img");
        ...
        $("#page")
            .on("mouseenter.re621.zoom", "post, .thumbnail, div.post-thumbnail, sb-ctwrap subitem[data-id] img", (event) => {
                if (scrolling) return;
            ...
            .on("mouseleave.re621.zoom", "post, .thumbnail, div.post-thumbnail, sb-ctwrap subitem[data-id] img", (event) => {
                let $ref = $(event.currentTarget);
                if ($ref.attr("hztarget"))
                    $ref = $ref.parents($ref.attr("hztarget"));
