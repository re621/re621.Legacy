...
(function () {
    ...
    1: [function (require, module, exports) {
        ...
        class Modal {
            ...
            enable() {
                ...
                this.$activeTrigger = this.triggers[0].element;
            }
            disable() {
    ...
    7: [function (require, module, exports) {
        ...
        Misc_1.MiscFunctionality.getInstance();
        FormattingHelper_1.FormattingHelper.init();

    }, {
        "./modules/BlacklistToggler": 8,
        "./modules/FormattingHelper": 9,
        "./modules/HeaderCustomizer": 10,
        "./modules/Misc": 11,
        "./modules/SettingsController": 12,
        "./modules/StructureUtilities": 13,
        "./modules/ThemeCustomizer": 14,
        "./modules/TitleCustomizer": 15
    }],
    ...
    9: [function (require, module, exports) {
        ...
        const button_definitions = {
            ...
            strikethrough: {
                icon: "&#xf0cc",
                title: `Strikethrough`,
                content: "[s]$selection[/s]"
            },
            underscore: {
                icon: "&#x" + "f0cd",
                title: "Underscore",
                content: "[u]$selection[/u]"
            },
            spacer: {
                icon: "&nbsp;",
                title: "Spacer",
            ...
            superscript: {
                icon: "&#x" + "f12b",
                title: "Superscript",
                content: "[sup]$selection[/sup]"
            },
            spoiler: {
                icon: "&#x" + "f20a",
                title: "Spoiler",
                content: "[spoiler]$selection[/spoiler]"
            },
            color: {
                icon: "&#x" + "f53f",
                title: "Color",
                content: "[color=]$selection[/color]"
            },
            code: {
                icon: "&#x" + "f121",
                title: "Code",
            ...
            section: {
                icon: "&#x" + "f103",
                title: "Section",
                content: "[section=Title]$selection[/section]"
            },
            tag: {
                icon: "&#x" + "f02b",
                title: "Tag",
        ...
        class FormattingHelper extends RE6Module_1.RE6Module {
            ...
            updateButtons() {
                ...
                let allButtons = $.map(buttonList, function (el) {
                    return el.get();
                });
            ...
            toggleButtonDrawer() {
                ...
                if (this.$container.attr("data-drawer") === "true") {
                    ...
                    var missingButtons = $.grep(Object.keys(button_definitions), function (el) {
                        return $.inArray(el, _self.fetchSettings("buttons")) == -1;
                    });
            ...
            addFormatting(button) {
                ...
                content = content.replace(/\$prompt/g, function () {
                    return prompt();
                });
    ...
    10: [function (require, module, exports) {
        ...
        class HeaderCustomizer extends RE6Module_1.RE6Module {
            ...
            getDefaultSettings() {
                let def_settings = {
                    tabs: [{
                        ...
                        {
                            name: "Wiki",
                            href: "/wiki_pages?title=help%3Ahome"
                        },
                        {
                            name: "Forum",
                            href: "/forum_topics"
            ...
            handleNewTabEvent() {
                ...
                this.updateModal.registerTrigger({
                    element: newTab.link
                });
                tabNameInput.val("");
                tabHrefInput.val("");
    ...
    11: [function (require, module, exports) {
        ...
        class MiscFunctionality extends RE6Module_1.RE6Module {
            constructor() {
                super();
                if (this.fetchSettings("removeSearchQueryString") === true && Url_1.Url.matches("/posts/")) {
                    this.removeSearchQueryString();
                }
            }
            removeSearchQueryString() {
            ...
            static getInstance() {
                if (this.instance == undefined)
                    this.instance = new MiscFunctionality();
                return this.instance;
            }
        }
        exports.MiscFunctionality = MiscFunctionality;
        MiscFunctionality.instance = new MiscFunctionality();
        ...
        class SettingsController {
            constructor() {
                ...
                this.modal = new Modal_1.Modal({
                    ...
                    subtabbed: true,
                    triggers: [{
                        element: addSettingsButton.link
                    }],
                    content: [{
                        name: "re621",
        ...
        class TitleCustomizer extends RE6Module_1.RE6Module {
            constructor() {
                ...
                if (this.fetchSettings("addArtistToTitle") === true) {
                    const tags = post.getTagsFromType(Tag_1.TagTypes.Artist).filter(tag => Tag_1.Tag.isArist(tag));
                    tagsToAddToTitle = tagsToAddToTitle.concat(tags);
                }
                if (this.fetchSettings("addCopyrightToTitle") === true) {
                    tagsToAddToTitle = tagsToAddToTitle.concat(post.getTagsFromType(Tag_1.TagTypes.Copyright));
                }
